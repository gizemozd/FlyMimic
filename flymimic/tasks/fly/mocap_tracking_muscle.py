...
class Physics(mujoco.Physics):
    ...
    def muscle_velocities(self):
        return np.clip(self.data.actuator_velocity.copy(), -100, 100)

    def muscle_activations(self):
        return np.clip(self.data.act.copy(), -10, 10)

    def muscle_forces(self):
        return np.clip(self.data.actuator_force.copy() / 1000, -10, 10)
